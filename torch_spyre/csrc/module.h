...
class GlobalRuntime {
 public:
  static void set(const std::shared_ptr<RuntimeContext>& runtime) {
    instance() = runtime;
  }
  static void reset() {
  ...
  static const std::shared_ptr<RuntimeContext>& get() {
    return instance();
  }
 ...
 private:
  ...
  static std::shared_ptr<RuntimeContext>& instance() {
    static std::shared_ptr<RuntimeContext> s;
    return s;
  }
};
